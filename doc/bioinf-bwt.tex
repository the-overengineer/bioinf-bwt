...
\begin{thebibliography}{1}
  	...
  	\bibitem{salson} M. Salson, T. Lecroq, M. Léonard, L. Moucharda,  A fourstage algorithm for updating a Burrows–Wheeler transform,in: Theoretical Computer Science,vol. 410, 2009, pp. 4350-4359 
	\bibitem{skripta} Mile Šikić, Mirjana Domazet-Lošo, 2013, Bioinformatika-skripta, Zagreb, Hrvatska,  Fakultet elekrotehnike i računarstva
	\bibitem{navaro} R. González, G. Navarro, Improved dynamic rank-select entropy-bound structures, in: Proc. of the Latin American Theoretical Informatics, LATIN, in: Lecture Notes in Comput. Sci., vol. 4957, 2008, pp. 374-386.
\end{thebibliography}
